...
import { Button } from "../session/styles"
...
const File = ({ file }) => {
  ...
  const formatDate = (dateISO) =>
    formatDistance(parseISO(dateISO), new Date(), { locale: ptBR })
  ...
  return (
    <Row>
      ...
      <Col>
        <Button type='button' onClick={() => handleClick(file)} small>
          Reinvindicar arquivo
        </Button>
      </Col>
    </Row>
  )
